# Install the dependencies in EC2
...
Or
Refer https://dev.to/aws-builders/installing-mysql-on-amazon-linux-2023-1512
...
## Trouble Shoot
if mysql was installed with steps mentioned in [link](https://dev.to/aws-builders/installing-mysql-on-amazon-linux-2023-1512)
Password can be found using `[root@ip-172-19-0-8 ~]# grep 'temporary password' /var/log/mysqld.log`.
```
[root@ip-172-19-0-8 ~]# grep 'temporary password' /var/log/mysqld.log
2024-06-24T19:54:09.058095Z 6 [Note] [MY-010454] [Server] A temporary password is generated for root@localhost: >5jF,?=2Fu73
[root@ip-172-19-0-8 ~]# mysql -u root -p
Enter password: 

..
..

mysql> ALTER USER 'root'@'localhost' IDENTIFIED BY 'Sathwick@18';
```
